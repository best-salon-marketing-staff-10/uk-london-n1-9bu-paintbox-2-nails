                                            ...
                                            <div className="nav-bar-services-sub-category">
                                                <div className="nav-bar-services-sub-category-details">
                                                    <div className="services-list-1">
                                                        <Link href={serviceCategory.tabletLinkToServiceCategory1} className="nav-bar-link-service-category">
                                                ...
                                                <div className="nav-bar-services-sub-category-details">
                                                    <div className="services-list-2">
                                                        <Link href={serviceCategory.tabletLinkToServiceCategory2} className="nav-bar-link-service-category">
                                                ...
                                                <div className="nav-bar-services-sub-category-details">
                                                    <div className="services-list-3">
                                                        <Link href={serviceCategory.tabletLinkToServiceCategory3} className="nav-bar-link-service-category">
                                                ...
                                                <div className="nav-bar-services-sub-category-details">
                                                    <div className="services-list-4">
                                                        <Link href={serviceCategory.tabletLinkToServiceCategory4} className="nav-bar-link-service-category">
                                                ...
                                                <div className="nav-bar-services-sub-category-details">
                                                    <div className="services-list-5">
                                                        <Link href={serviceCategory.tabletLinkToServiceCategory5} className="nav-bar-link-service-category">
                                                ...
                                                <div className="nav-bar-services-sub-category-details">
                                                    <div className="services-list-6">
                                                        <Link href={serviceCategory.tabletLinkToServiceCategory6} className="nav-bar-link-service-category">
                                                ...
                                                <div className="nav-bar-services-sub-category-details">
                                                    <div className="services-list-7">
                                                        <Link href={serviceCategory.tabletLinkToServiceCategory7} className="nav-bar-link-service-category">
